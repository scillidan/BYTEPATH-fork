...
function GlitchDisplacement:new(area, x, y, opts)
    ...
    if self.type == 'horizontal_bar_shift' then
        ...
        local r = 127/255 + love.math.random(-4, 4)*(glitch/10)/255
        self.color = {r, r, r}
        self.timer:tween(random(0.05, 0.4), self, {color = {127/255, 127/255, 127/255}}, 'in-out-cubic', function() self.dead = true end)
